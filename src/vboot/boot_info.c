...
static int gki_setup_bootconfig(struct boot_info *bi, VbSelectAndLoadKernelParams *kp,
				char *fb_cmd)
{
 ...
 */
static int setup_pvmfw(struct boot_info *bi, VbSelectAndLoadKernelParams *kparams)
{
	int ret;
	uint32_t status;
