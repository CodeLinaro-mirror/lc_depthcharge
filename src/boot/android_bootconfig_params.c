...
static int append_serial_num(struct bootconfig *bc, VbSelectAndLoadKernelParams *kp)
{
...
static int append_display_orientation(struct bootconfig *bc, VbSelectAndLoadKernelParams *kp)
{
...
static int append_boot_part_uuid(struct bootconfig *bc, VbSelectAndLoadKernelParams *kp)
{
...
static int append_boot_source(struct bootconfig *bc, VbSelectAndLoadKernelParams *kp)
{
...
int append_android_bootconfig_params(struct bootconfig *bc, VbSelectAndLoadKernelParams *kp)
{
